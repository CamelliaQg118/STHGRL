...
def leiden(adata, n_clusters, use_rep='emb', key_added='STHGRL', random_seed=42):
...
def louvain(adata, n_clusters, use_rep='emb', key_added='STHGRL', random_seed=42):
    sc.pp.neighbors(adata, use_rep=use_rep)
...
def mclust_R(adata, n_clusters, use_rep='STHGRL', key_added='STHGRL', random_seed=42):
    """\
